...
import leftImage from '@/assets/会员登录/2.png'
import rightBgImage from '@/assets/会员登录/1.png'
...
.login-page {
  min-height: 100vh;
  background: linear-gradient(to bottom, #E8F4FF 0%, #F0F8FF 80px, #FFFFFF 120px, #FFFFFF 100%);
  display: flex;
...
/* Footer line - orange/brown color */
.footer-line {
